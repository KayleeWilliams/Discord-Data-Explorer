<template>
  <div class="flex flex-row h-full justify-center lg:justify-end items-center content-center text-primary gap-4" data-html2canvas-ignore="true">
    <button @click="captureScreenshot" class="bg-secondary text-primary p-2 border-accent border-2 rounded-full hover:bg-accent hover:text-secondary active:bg-accent active:text-secondary transition ease-in-out duration-300 ">
    ...
    <button @click="exportData" class="bg-secondary text-primary p-2 border-accent border-2 rounded-full hover:bg-accent hover:text-secondary active:bg-accent active:text-secondary transition ease-in-out duration-300 ">
